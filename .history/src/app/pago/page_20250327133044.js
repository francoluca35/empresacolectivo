...
export default function Pago() {
  ...
  return (
    <section className="min-h-screen w-full bg-red-400 flex items-center justify-center px-4 py-8">
    <div className="w-full max-w-2xl bg-white rounded-lg shadow-lg p-6">
      ...
      <form onSubmit={handleSubmit} className="mt-6 space-y-3">
        ...
        <label className="block text-gray-700 mt-2 font-medium">Método de Pago:</label>
        <select
          name="metodoPago"
          onChange={handleChange}
          required
