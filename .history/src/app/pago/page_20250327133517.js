...
<section className="h-screen w-full bg-red-400 flex items-center justify-center px-4">
  <div className="w-full max-w-2xl bg-white rounded-lg shadow-lg p-6 h-[95vh] overflow-hidden flex flex-col justify-between">
    <div className="space-y-1 overflow-y-auto">
      ...
      <form onSubmit={handleSubmit} className="mt-4 space-y-2">
        ...
        <label className="block text-gray-700 font-medium mt-2">Método de Pago:</label>
        <select
          name="metodoPago"
          onChange={handleChange}
          required
          className="w-full p-2 border bg-slate-200 text-black placeholder:text-black border-gray-300 rounded"
        >
