...
const eventos = [
  { year: "2012", img: "/timeline/2012.jpg" },
  { year: "2013", img: "/timeline/2013.jpg" },
  { year: "2014", img: "/timeline/2014.jpg" },
  { year: "2015", img: "/timeline/2015.jpg" },
  { year: "2016", img: "/timeline/2016.jpg" },
  { year: "2017", img: "/timeline/2017.jpg" },
];
...
export default function Timeline() {
  ...
  <section className="bg-white py-16 px-4 mt-20 md:mt-14">
      ...
      <div className="overflow-x-auto">
        <div className="flex gap-10 justify-start md:justify-center px-4">
