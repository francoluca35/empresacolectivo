  ...
  return (
    <>
      ...
      <section className="bg-white py-16 px-4 mt-20 md:mt-14">
        ...
        <div className="overflow-x-auto custom-scroll-hide">


          <div className="flex flex-col scrollbar-hide overflow-x-auto md:flex-row gap-10 justify-center items-start px-4">
            {eventos.map((evento, index) => (
              ...
              >
                ...
                <div className="w-px h-10 border-l-2 border-dotted border-gray-400 mx-auto mb-2" />
                ...
                <div className="w-px h-10 border-l-2 border-dotted border-gray-400 mx-auto mt-2" />
              </motion.div>
            ))}
          </div>
        </div>
