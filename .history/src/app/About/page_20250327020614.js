...
const eventos = [
  { year: "2012", img: "/timeline/2012.jpg", text:"Comienza la historia de Rutatlantica en manos de Antonio Arcos. La empresa estaba ubicada en la ciudad de Cuidadela, Buenos Aires. Sus colores característicos eran blanco, azul y celeste."},
  ...
  <div className="flex flex-col md:flex-row gap-10 justify-center items-start px-4">
    {eventos.map((evento, index) => (
      <div key={index} className="text-center max-w-xs">
        ...
        {/* Año */}
        <div className="mt-3 font-semibold text-gray-800 text-lg">{evento.year}</div>

        {/* Texto truncado a 60 caracteres */}
        <div className="mt-1 text-gray-700 text-sm">
          {evento.text.length > 60 ? evento.text.slice(0, 60) + "..." : evento.text}
        </div>
