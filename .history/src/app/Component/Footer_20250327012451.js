...
export default function Footer() {
  return (
    <div>
      ...
      <span>Created by <a className="text-red-600 hover:text-[12px]" href="https://deamondd.com" target="_blank">Deamon Company</a></span> | | Todos los derechos reservados © 2025 
      </div>
    </div>
  );
}