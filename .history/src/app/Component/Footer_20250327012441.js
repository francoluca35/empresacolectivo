...
export default function Footer() {
  return (
    <div>
      <footer className="bg-red-600 text-white py-10 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-8 items-start text-sm">
          ...
          <div className="flex flex-col items-start">
            <img src="Assets/footer.png" alt="Logo" className="w-28" />
          </div>
      ...
      <span>Created by <a className="text-red-600 hover:text-[40px]" href="https://deamondd.com" target="_blank">Deamon Company</a></span> | | Todos los derechos reservados © 2025 
      </div>
    </div>
  );
}