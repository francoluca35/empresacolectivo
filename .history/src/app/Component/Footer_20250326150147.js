        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-8 items-start text-sm">
          ...
          <div>
            ...
            <ul className="space-y-1">
              ...
              <li><a href="#" className="hover:underline">Fundación Flecha Bus</a></li>
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li><a href="#" className="hover:underline">Club Recorrer</a></li>
          ...
          <div className="flex justify-start md:justify-end">
            <button className="bg-white text-blue-900 px-4 py-2 rounded-md font-bold shadow-md">
              BOTÓN DE ARREPENTIMIENTO
            </button>
          </div>
        </div>
