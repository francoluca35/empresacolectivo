...
>
      ...
      <div className="max-w-2xl mx-auto flex flex-col gap-6">
        ...
        <div className="border-4 border-red-600 rounded-2xl py-6 px-4 shadow-md hover:bg-white">
          <h3 className="text-xl text-red-900 font-bold mb-2">ATENCIÓN AL CLIENTE:</h3>
        ...
        {/* Marketing */}
        <div className="border-4 border-red-600 rounded-2xl py-6 px-4 shadow-md hover:bg-white">
          <h3 className="text-xl text-red-900 font-bold mb-2">MARKETING:</h3>
          <p className="text-gray-800 flex justify-center items-center gap-2">
        ...
        {/* WhatsApp */}
        <div className="border-4 border-red-600 rounded-2xl py-6 px-4 shadow-md hover:bg-white">
          <h3 className="text-xl text-red-900 font-bold mb-2">WHATSAPP:</h3>
