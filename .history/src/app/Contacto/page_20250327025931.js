...
export default function Contacto() {
  return (
    ...
    <Navbar />
    <section
  className="bg-cover bg-center bg-no-repeat mt-20 md:mt-20 py-20 px-6 text-center"
  style={{
    backgroundImage: "url('Assets/fondo-contacto.png')", // asegurate de que esté en la carpeta public/
  }}
>
