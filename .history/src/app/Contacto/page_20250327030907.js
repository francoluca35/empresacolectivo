...
>
      ...
      <div className="max-w-2xl mx-auto flex flex-col gap-6 ">
        {/* Atención al cliente */}
        <div className="border-4 border-red-600 rounded-2xl py-6 px-4 shadow-md hover:bg-white  hover:text-black">
          <h3 className="text-xl text-white font-bold mb-2 hover:text-black">ATENCIÓN AL CLIENTE:</h3>
          <p className="text-whirw flex justify-center items-center gap-2 hover:text-black">
        ...
        <div className="border-4 border-red-600 rounded-2xl py-6 px-4 shadow-md hover:bg-white">
          <h3 className="text-xl text-white font-bold mb-2 hover:text-black">MARKETING:</h3>
          <p className="text-white flex justify-center items-center gap-2 hover:text-black">
        ...
        {/* WhatsApp */}
        <div className="border-4 border-red-600 rounded-2xl py-6 px-4 shadow-md hover:bg-white">
          <h3 className="text-xl text-white font-bold mb-2 hover:text-black">WHATSAPP:</h3>
          <p className="text-white flex justify-center items-center gap-2 mb-2 hover:text-black">
            <FaWhatsapp /> +54 9 11 3434 5000
          </p>
          <p className="text-xs text-white hover:text-black">HORARIO DE ATENCIÓN: LUNES A DOMINGOS 24HS</p>
        </div>
