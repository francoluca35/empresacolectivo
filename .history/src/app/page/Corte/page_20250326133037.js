  ...
  return (
    <section className="relative w-full h-screen overflow-hidden flex items-center">
      ...
      <div className="absolute right-0 top-0 w-full md:w-1/2 h-full bg-black/70 backdrop-blur-sm z-10 flex flex-col justify-center px-10 text-white">
        ...
        <div className="-mt-10 relative md:-left-22 -left-10">
          <img
        ...
        {/* Texto */}
        <h2 className="text-xl -mt-10 md:text-2xl text-yellow-500 font-semibold tracking-wide text-center md:text-right">
