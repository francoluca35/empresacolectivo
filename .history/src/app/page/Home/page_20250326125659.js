      ...
      <div className="flex flex-col md:flex-row max-w-6xl w-full">
        ...
        <div className="w-full md:w-1/2 p-8 flex flex-col space-y-4 text-black bg-opacity-30 bg-black backdrop-blur-lg rounded-3xl shadow-2xl mr-4">
          ...
          {tipoViaje === "idaYvuelta" && (
            <input
              type="date"
              className="rounded-xl text-black px-4 py-3 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-cyan-800"
            />
          )}
          ...
          <input
            ...
            className="rounded-xl bg-white placeholder:text-gray-200 px-4 py-3 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-cyan-800"
          />
