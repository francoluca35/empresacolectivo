...
export default function Home() {
  ...
  return (
    <main
      ...
      style={{
        backgroundImage: "url('/Assets/tu-fondo-principal.jpg')", // Reemplaza con tu imagen de fondo principal
    ...
    >
      <div className="bg-white bg-opacity-10 backdrop-blur-lg rounded-3xl shadow-2xl flex flex-col md:flex-row overflow-hidden max-w-6xl w-full"
           style={{
            backgroundImage: "url('/Assets/fondo-home.jpg')", // Fondo para el buscador
            backgroundSize: "cover",
            backgroundPosition: "center",
          }}>
        {/* Buscador */}
        <div
          className="w-full md:w-1/2 p-8 flex flex-col space-y-4 text-black"
