  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row max-w-6xl w-full">
        {/* Buscador */}
        <div className="w-full md:w-1/2 p-8 flex flex-col space-y-4 text-black bg-opacity-30 bg-red-400 backdrop-blur-lg rounded-3xl shadow-2xl mr-4"> {/* Agregamos margen derecho */}
          <input
            type="text"
            placeholder="Desde"
