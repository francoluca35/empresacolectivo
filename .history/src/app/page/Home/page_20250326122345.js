...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-sky-300 flex justify-center items-center p-4">
      <div className="bg-white bg-opacity-90 backdrop-blur-lg rounded-3xl shadow-2xl flex flex-col md:flex-row overflow-hidden max-w-6xl w-full">
        ...
        {/* Imagen promocional */}
        <div className="w-full md:w-1/2 p-8 flex items-center justify-center bg-gradient-to-br from-blue-400 to-sky-200">
          <div className="w-full max-w-md h-auto overflow-hidden rounded-2xl shadow-xl">
            <img
              src="/descuento1.jpg"
              alt="promo"
