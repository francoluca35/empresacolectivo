...
export default function Home() {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-3xl shadow-2xl flex flex-col md:flex-row overflow-hidden max-w-6xl w-full">
        {/* Buscador */}
        <div className="w-full md:w-1/2 p-8 flex flex-col space-y-4 text-black bg-opacity-10 backdrop-blur-lg"> 
          <input
            type="text"
            placeholder="Desde"
        ...
        <div className="w-full md:w-1/2 p-8 bg-opacity-10 flex items-center justify-center">
