...
export default function Home() {
  ...
  return (
    <main
      ...
      style={{
        backgroundImage: "url('/Assets/fondo-home.jpg')", // Reemplaza con tu imagen de fondo principal
        backgroundSize: "cover",
        backgroundPosition: "center",
      }}
    >
      <div className="bg-white bg-opacity-10 backdrop-blur-lg rounded-3xl shadow-2xl flex flex-col md:flex-row overflow-hidden max-w-6xl w-full">
        {/* Buscador */}
        <div
          className="w-full bg-white bg-opacity-10 backdrop-blur-lg rounded-3xl shadow-2xl flex flex-col md:flex-row overflow-hidden md:w-1/2 p-8 flex flex-col space-y-4 text-black"
        >
          <input
            type="text"
            placeholder="Desde"
