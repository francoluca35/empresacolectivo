...
import Unidades from "./page/page";
...
export default function Servicios() {
  ...
  return (
    <>
      ...
      <section className="bg-white">
        {/* Banner superior */}
        <div className="relative mt-20 w-full h-[250px] md:h-[350px] overflow-hidden">
  <img
  ...
  />
          ...
          <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
            <h2 className="text-4xl md:text-5xl font-bold text-red-400 uppercase">Servicios</h2>
          </div>
        </div>
